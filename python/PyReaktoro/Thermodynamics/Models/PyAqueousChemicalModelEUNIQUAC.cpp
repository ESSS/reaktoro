...
void exportAqueousChemicalModelEUNIQUAC(py::module& m)
{
    ...
    py::class_<EUNIQUACParams>(m, "EUNIQUACParams")
        ...
        .def("getAvailableSpeciesNames", &EUNIQUACParams::getAvailableSpeciesNames)
        ...
        .def("setDebyeHuckelModelAsFallback", &EUNIQUACParams::setDebyeHuckelModelAsFallback)
        .def("isDebyeHuckelFallbackEnabled", &EUNIQUACParams::isDebyeHuckelFallbackEnabled)
